...
CREATE TABLE IF NOT EXISTS generation_tasks (
    ...
    capability_contract_id TEXT NOT NULL CHECK(length(capability_contract_id) BETWEEN 3 AND 128),
    capability_contract_major INTEGER NOT NULL CHECK(capability_contract_major BETWEEN 1 AND 65535),
    capability_contract_minor INTEGER NOT NULL CHECK(capability_contract_minor BETWEEN 0 AND 65535),
