...
export const templates = [
  ...
  ["AI一镜到底📹｜欢迎来到石湾镇 - Welcome to Stone Bay", "ZeteroGeneouZ", "精选画布", "", "20", ""],
  ["中古风室内空间720度空间一致性", "三千问Atelier", "专业影视", "专业", "10", ""],
  ["《Y2K-iphone》--自动化工作流", "贾麦子", "TV工具箱", "先锋", "12", ""],
  [
    "贵司有尾",
    "Tassi",
    "大乱斗｜vol.1 显形记",
  ...
  ["黎明之刃PV", "133****2591", "动漫游戏", "", "11", ""],
  ["VIVO手机短片《柳宗元的独钓“玄机”》", "是YY呀", "商业广告", "先锋", "216", ""],
  ["24节气 | 芒种", "小团长安铺子", "教育生活", "先锋", "6", ""],
  [
    "《Wrong Room》",
    "简恩",
    "大乱斗｜vol.2《AI，想象和尖叫》",
  ...
  ["奇怪的迷宫", "Babluer拜拜", "短剧漫剧", "先锋", "12", ""],
  ["《异常放送》丨File 02.形影分离", "Chiraku", "专业影视", "", "5", ""],
  ["Remenber 蛋仔派对 逃出惊魂夜 海瑟角色曲MV", "那边的蛋仔", "动漫游戏", "先锋", "275", ""],
  ["《UnTouchable》AI音乐MV短片", "Zeno", "精选画布", "", "404", ""],
  ["沙僧终于不洗了", "迈克的AiGC世界", "专业影视", "专业", "11", ""],
  ["高端游戏手柄｜世界杯联名款概念TVC", "追逐星辰", "商业广告", "先锋", "13", ""],
  ["见鬼", "niu_456000", "短剧漫剧", "先锋", "6", ""]
