...
type PanelId = "add" | "toolbox" | "assets" | "history" | "shortcuts" | "help" | null;
...
function panelTitle(panel: Exclude<PanelId, null>) {
  const titles = {
    add: "添加节点",
    toolbox: "工具箱",
    assets: "我的素材",
...
function ToolboxPanel({ onUse }: { onUse: (presetId: string) => void }) {
  return (
    <div className="drawer-body">
